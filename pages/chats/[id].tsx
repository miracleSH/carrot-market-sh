      ...
      <div className="fixed w-full mx-auto max-w-md bottom-3 inset-x-0">
        <div className="flex relative items-center">
          ...
          <div className="absolute inset-y-0 flex py-1.5 right-0">
            <span className="flex focus:ring-2 focus:ring-offset-2 focus:ring-orange-400 items-center bg-orange-500 rounded-full px-3 hover:bg-orange-600 cursor-pointer text-sm text-white mr-1">&rarr;</span>
          </div>
        </div>
      </div>
    </div>
