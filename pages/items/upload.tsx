  ...
  return (
    <Layout canGoBack>
      <div className='px-4 pt-4'>
        ...
        <div className='my-5'>
          <label className='mb-1 block text-sm font-medium text-gray-900' htmlFor='price'>
            Price
          </label>
        ...
        <div>
          ...
          <div>
            <textarea
              className='mt-1 shadow-sm w-full focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 rounded-md border-gray-300'
              rows={4}
            />
          </div>
        </div>
