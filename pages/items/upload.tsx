...
const Upload: NextPage = () => {
  return (
    <div className='px-4 pt-16'>
      ...
      <div className='my-5'>
        <label className='mb-1 block text-sm font-medium text-gray-900' htmlFor='price'>Price</label>
      ...
      <div>
        ...
        <div>
          <textarea className='mt-1 shadow-sm w-full focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 rounded-md border-gray-300' rows={4} />
        </div>
      </div>
      <button className='mt-5 bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 border border-transparent shadow-sm rounded-md text-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 focus:outline-none'>Upload product</button>
    </div>
  )
}
