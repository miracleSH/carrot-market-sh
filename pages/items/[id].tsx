      ...
      <div className='mb-8'>
        ...
        <div className='mt-6'>
          ...
          <p className='text-base my-4 text-gray-700'>
            ...
            get it, I&apos;m gonna shoot you in the head then and there. Then I&apos;m gonna shoot that bitch in the kneecaps, find out where my
            ...
            ni**a Winston or anybody else is in there, you the first motherfucker to get shot. You understand?
          </p>
          <div className='flex items-center justify-between space-x-2'>
            ...
            <button className='p-3 rounded-md items-center justify-center text-gray-400 hover:bg-gray-100 hover:text-gray-500'>
